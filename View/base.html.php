...
<!-- sav  -->
  ...
  <!-- admin -->
          ...
          <form class="d-flex" role="search">
            ...
            <a href="user&action=login" class="btn btn-outline-success ">Connexion</a>
  ...
  <footer class="container py-5 fixed-bottom ">
      <div class="row">
        <div class="col-12 col-md">
          ...
          <H5>E-SUCCESS</H5>
          <p>Nous sommes une équipe de 4 personnes passionnées par le développement, et nous avons développé ce site pour vendre des produits spécialisés dans le domaine du sport.</p>
        </div>
