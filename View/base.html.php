...
<head>
    ...
    <title>E-success</title>
    <!-- css -->
    <link rel="stylesheet" href="./Public/style/fontawesome-free-6.5.1-web/css/all.css">
    <link rel="stylesheet" href="./Public/style/bootstrap-5.3.2-dist/css/bootstrap.min.css">
    ...
    <!-- bloc le dropdown de parametres -->
                    ...
                    <div class="collapse navbar-collapse" id="navbarScroll">
                        ...
                        <ul class="nav justify-content-lg-end flex-md-row">
                            ...
                            <?php if ($_SESSION['login'] == 'visiteur') : ?>
                                ...
                                <a href="login" class="btn btn-outline-success w-100 ">Se connecter ou
                                    s'inscrire</a>
                            <?php endif; ?>
                            </li>
                        </ul>
